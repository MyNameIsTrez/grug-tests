...
static void ok_global_call_using_null_id(void *on_fns, void *g, size_t resources_size, const char **resources, size_t entities_size, const char **entities, const char **entity_types) {
	(void)on_fns;
